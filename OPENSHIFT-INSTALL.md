...
**Solution:** The Helm chart v1.6.4+ is already configured correctly for OpenShift. Just make sure you're NOT specifying `runAsUser` or `fsGroup` in your values file.
